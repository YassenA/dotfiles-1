# Generated by Powerlevel10k configuration wizard on 2023-02-22 at 22:01 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 01704.
# Wizard options: awesome-fontconfig + powerline + python, small icons, unicode,
# lean_8colors, 24h time, 1 line, sparse, few icons, concise, instant_prompt=verbose.
